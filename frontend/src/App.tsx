  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      if (aiMessage.sessionId) {
        setChatSessionId(aiMessage.sessionId);
      }
      setMessages((prev) => [
        ...prev,
        { text: aiMessage.reply || "No response from backend", sender: "AI" },
      ]);
    } catch {
      setMessages((prev) => [
        ...prev,
        { text: "Error: Could not reach backend", sender: "AI" },
      ]);
    } finally {
      setIsChatting(false);
    }
      ...
      {isOpen && (
        <div className="chat-window">
          ...
          <div className="chat-window-textbox">
            ...
            {isChatting && <div className="ai-message">Thinking...</div>}
          ...
          <div className="chat-input">
            ...
            />
            <button className="chat-input-button" onClick={sendMessage} disabled={isChatting}>
